...
export const TRANSLATIONS: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    "features.intelOpsDesc": "Automate class scheduling, admissions workflows, facility management, and staff payroll with zero paperwork.",
    ...
    "cta.subtitle": "Join hundreds of forward-thinking institutions using GGPS School to elevate their educational standard.",
    ...
    "footer.campusAddress": "GGPS School Campus, Main Avenue",
    "footer.applyOnline": "Apply Online",
    "footer.rights": "© 2026 GGPS School. All rights reserved.",
  ...
  es: {
    ...
    "features.intelOpsDesc": "Automatice horarios de clase, admisiones, gestión de instalaciones y nómina del personal con cero papeleo.",
    ...
    "cta.subtitle": "Únase a cientos de instituciones visionarias que utilizan GGPS School para elevar sus estándares educativos.",
    ...
    "login.signInSubtitle": "Accede al portal escolar de GGPS School y gestiona tu trayectoria académica.",
  ...
  fr: {
    ...
    "features.intelOpsDesc": "Automatisez les plannings, les admissions, la gestion des installations et la paie sans paperasse.",
    ...
    "cta.subtitle": "Rejoignez des centaines d'établissements avant-gardistes qui utilisent GGPS School pour élever leurs standards.",
    ...
    "footer.contactSupport": "CONTACT & SUPPORT",
    "footer.campusAddress": "Campus GGPS School, Avenue Principale",
    "footer.applyOnline": "Postuler en Ligne",
    "footer.rights": "© 2026 GGPS School. Tous droits réservés.",
    ...
    "login.signInSubtitle": "Accédez au portail de GGPS School et gérez votre parcours académique.",
  ...
  de: {
    ...
    "features.intelOpsDesc": "Automatisieren Sie Stundenplanung, Zulassungen, Campusverwaltung und Gehaltsabrechnung ohne Papierkram.",
    ...
    "cta.subtitle": "Schließen Sie sich Hunderten von zukunftsorientierten Institutionen an, die GGPS School nutzen.",
    ...
    "footer.campusAddress": "GGPS School Campus, Hauptallee",
    "footer.applyOnline": "Online Bewerben",
    "footer.rights": "© 2026 GGPS School. Alle Rechte vorbehalten.",
    ...
    "login.signInSubtitle": "Greifen Sie auf das GGPS School Portal zu und verwalten Sie Ihren Bildungsweg.",
