...
export default function AcademicClosingPage() {
  ...
  const checklist = [
    ...
    { title: "Term Assessment Observations & Reports Published", status: "Validated", desc: "All Pre-KG, LKG & UKG milestone reports signed.", ok: true },
    { title: "Montessori & Activity Kit Inventory Completed", status: "Validated", desc: "Zero outstanding learning materials uncounted.", ok: true },
    { title: "Daycare & Facility Sanitization Audit", status: "Validated", desc: "All learning centers prepped for new session rollover.", ok: true },
    { title: "Student Cohort Promotion Prepared", status: "Ready", desc: "Pre-KG -> LKG -> UKG progression rules active.", ok: true },
  ];
